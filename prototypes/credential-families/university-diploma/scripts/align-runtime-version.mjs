...
const targetFile = path.join(packageRoot, 'src', 'managed', 'university-diploma', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'university-diploma', 'contract', 'index.d.ts');
