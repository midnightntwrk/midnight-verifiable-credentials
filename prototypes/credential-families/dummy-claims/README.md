...
- `npm run build -w ./prototypes/credential-families/dummy-claims`
- `npm run lint -w ./prototypes/credential-families/dummy-claims`
- `npm run typecheck -w ./prototypes/credential-families/dummy-claims`
