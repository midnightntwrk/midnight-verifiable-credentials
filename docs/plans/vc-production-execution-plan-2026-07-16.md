...
| PR-A1 | `codex/vc-verification-contract-v1` | `develop` after A0 | transcript/public-input/result types, evidence bindings, fail-closed API skeleton, digest and mutation tests; no final-profile claim | A0 merged; core build/test, typecheck, surface discipline, light gate, Claude security review |
