...
## Retired prototype fixture exception

The former repository-local prototype fixture manifest and Git LFS artifact set
were removed with the credential-family and compatibility packages. Deployable
consumer repositories now own their generated proving artifacts and apply the
production distribution decision above.
