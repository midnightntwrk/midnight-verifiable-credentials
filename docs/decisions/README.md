...
This directory contains only decisions that still constrain the core
repository. Superseded product, protocol, status-service, connector, and
package-graph decisions remain available in Git history and linked GitHub
issues; they are not active documentation.
