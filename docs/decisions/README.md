...
| [0005](./0005-verification-execution-and-authority.md) | Superseded | Use one Compact verification model with explicit on-chain authority and restricted off-chain profiles |
