...
const targetFile = path.join(packageRoot, 'src', 'managed', 'credentials', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'credentials', 'contract', 'index.d.ts');
