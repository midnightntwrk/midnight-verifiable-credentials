...
const targetFile = path.join(packageRoot, 'src', 'managed', 'iso-registry', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'iso-registry', 'contract', 'index.d.ts');
