...
const _descriptor_2 = new _SchemaRef_0();
...
class _VerificationMethodRef_0 {
  ...
  fromValue(value_0) {
    return {
      didContractAddress: _descriptor_3.fromValue(value_0),
      methodId: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.didContractAddress).concat(_descriptor_1.toValue(value_0.methodId));
  }
}
...
class _ExplicitHolderBinding_0 {
  ...
  fromValue(value_0) {
    return {
      holderVerificationMethodRef: _descriptor_4.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.holderVerificationMethodRef);
  }
}
...
const _descriptor_13 = new __compactRuntime.CompactTypeVector(2, _descriptor_8);
...
class _DummyNestedClaims_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_10.alignment().concat(_descriptor_11.alignment().concat(_descriptor_12.alignment())));
  }
  fromValue(value_0) {
    return {
      booleanValue: _descriptor_8.fromValue(value_0),
      bigUnsignedValue: _descriptor_10.fromValue(value_0),
      bytesValue: _descriptor_11.fromValue(value_0),
      fieldValue: _descriptor_12.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.booleanValue).concat(_descriptor_10.toValue(value_0.bigUnsignedValue).concat(_descriptor_11.toValue(value_0.bytesValue).concat(_descriptor_12.toValue(value_0.fieldValue))));
  }
}

const _descriptor_17 = new _DummyNestedClaims_0();

const _descriptor_18 = new __compactRuntime.CompactTypeVector(2, _descriptor_17);

class _DummyClaims_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_9.alignment().concat(_descriptor_7.alignment().concat(_descriptor_10.alignment().concat(_descriptor_11.alignment().concat(_descriptor_1.alignment().concat(_descriptor_12.alignment().concat(_descriptor_13.alignment().concat(_descriptor_14.alignment().concat(_descriptor_15.alignment().concat(_descriptor_16.alignment().concat(_descriptor_17.alignment().concat(_descriptor_18.alignment()))))))))))));
  }
  fromValue(value_0) {
    return {
      booleanValue: _descriptor_8.fromValue(value_0),
      byteSizedUnsignedValue: _descriptor_9.fromValue(value_0),
      mediumUnsignedValue: _descriptor_7.fromValue(value_0),
      bigUnsignedValue: _descriptor_10.fromValue(value_0),
      bytes16Value: _descriptor_11.fromValue(value_0),
      bytes32Value: _descriptor_1.fromValue(value_0),
      fieldValue: _descriptor_12.fromValue(value_0),
      booleanVector: _descriptor_13.fromValue(value_0),
      uintVector: _descriptor_14.fromValue(value_0),
      bytesVector: _descriptor_15.fromValue(value_0),
      fieldVector: _descriptor_16.fromValue(value_0),
      nestedValue: _descriptor_17.fromValue(value_0),
      nestedVector: _descriptor_18.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.booleanValue).concat(_descriptor_9.toValue(value_0.byteSizedUnsignedValue).concat(_descriptor_7.toValue(value_0.mediumUnsignedValue).concat(_descriptor_10.toValue(value_0.bigUnsignedValue).concat(_descriptor_11.toValue(value_0.bytes16Value).concat(_descriptor_1.toValue(value_0.bytes32Value).concat(_descriptor_12.toValue(value_0.fieldValue).concat(_descriptor_13.toValue(value_0.booleanVector).concat(_descriptor_14.toValue(value_0.uintVector).concat(_descriptor_15.toValue(value_0.bytesVector).concat(_descriptor_16.toValue(value_0.fieldVector).concat(_descriptor_17.toValue(value_0.nestedValue).concat(_descriptor_18.toValue(value_0.nestedVector)))))))))))));
  }
}
...
class _Credential_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_5.alignment().concat(_descriptor_6.alignment().concat(_descriptor_7.alignment().concat(_descriptor_8.alignment().concat(_descriptor_7.alignment().concat(_descriptor_19.alignment().concat(_descriptor_20.alignment().concat(_descriptor_1.alignment()))))))))));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.version).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_5.toValue(value_0.holderBinding).concat(_descriptor_6.toValue(value_0.statusBinding).concat(_descriptor_7.toValue(value_0.issuedAt).concat(_descriptor_8.toValue(value_0.hasExpiration).concat(_descriptor_7.toValue(value_0.expiresAt).concat(_descriptor_19.toValue(value_0.claims).concat(_descriptor_20.toValue(value_0.claimCommitments).concat(_descriptor_1.toValue(value_0.claimRoot)))))))))));
  }
}
...
class _Signature_0 {
  alignment() {
    return _descriptor_22.alignment().concat(_descriptor_12.alignment());
  }
  fromValue(value_0) {
    return {
      r: _descriptor_22.fromValue(value_0),
      s: _descriptor_12.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_22.toValue(value_0.r).concat(_descriptor_12.toValue(value_0.s));
  }
}
...
class _Proof_0 {
  alignment() {
    return _descriptor_4.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_22.alignment().concat(_descriptor_23.alignment()))));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.signerVerificationMethodRef).concat(_descriptor_7.toValue(value_0.createdAt).concat(_descriptor_1.toValue(value_0.challengeHash).concat(_descriptor_22.toValue(value_0.publicKey).concat(_descriptor_23.toValue(value_0.signature)))));
  }
}
...
class _DummyClaimsPresentationRequest_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_1.alignment()))))))))))))))))))));
  }
  fromValue(value_0) {
    return {
      version: _descriptor_0.fromValue(value_0),
      schema: _descriptor_2.fromValue(value_0),
      issuerVerificationMethodRef: _descriptor_4.fromValue(value_0),
      requireBooleanValueDisclosure: _descriptor_8.fromValue(value_0),
      requireByteSizedUnsignedValueDisclosure: _descriptor_8.fromValue(value_0),
      requireMediumUnsignedValueDisclosure: _descriptor_8.fromValue(value_0),
      requireBigUnsignedValueDisclosure: _descriptor_8.fromValue(value_0),
      requireBytes16ValueDisclosure: _descriptor_8.fromValue(value_0),
      requireBytes32ValueDisclosure: _descriptor_8.fromValue(value_0),
      requireFieldValueDisclosure: _descriptor_8.fromValue(value_0),
      requireBooleanVectorDisclosure: _descriptor_8.fromValue(value_0),
      requireUintVectorDisclosure: _descriptor_8.fromValue(value_0),
      requireBytesVectorDisclosure: _descriptor_8.fromValue(value_0),
      requireFieldVectorDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedValueDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedBooleanValueDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedBigUnsignedValueDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedBytesValueDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedFieldValueDisclosure: _descriptor_8.fromValue(value_0),
      requireNestedVectorDisclosure: _descriptor_8.fromValue(value_0),
      verifierChallengeHash: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.version).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_8.toValue(value_0.requireBooleanValueDisclosure).concat(_descriptor_8.toValue(value_0.requireByteSizedUnsignedValueDisclosure).concat(_descriptor_8.toValue(value_0.requireMediumUnsignedValueDisclosure).concat(_descriptor_8.toValue(value_0.requireBigUnsignedValueDisclosure).concat(_descriptor_8.toValue(value_0.requireBytes16ValueDisclosure).concat(_descriptor_8.toValue(value_0.requireBytes32ValueDisclosure).concat(_descriptor_8.toValue(value_0.requireFieldValueDisclosure).concat(_descriptor_8.toValue(value_0.requireBooleanVectorDisclosure).concat(_descriptor_8.toValue(value_0.requireUintVectorDisclosure).concat(_descriptor_8.toValue(value_0.requireBytesVectorDisclosure).concat(_descriptor_8.toValue(value_0.requireFieldVectorDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedValueDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedBooleanValueDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedBigUnsignedValueDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedBytesValueDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedFieldValueDisclosure).concat(_descriptor_8.toValue(value_0.requireNestedVectorDisclosure).concat(_descriptor_1.toValue(value_0.verifierChallengeHash)))))))))))))))))))));
  }
}
...
class _DummyNestedDisclosures_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_10.alignment().concat(_descriptor_8.alignment().concat(_descriptor_11.alignment().concat(_descriptor_8.alignment().concat(_descriptor_12.alignment())))))));
  }
  fromValue(value_0) {
    return {
      revealBooleanValue: _descriptor_8.fromValue(value_0),
      booleanValue: _descriptor_8.fromValue(value_0),
      revealBigUnsignedValue: _descriptor_8.fromValue(value_0),
      bigUnsignedValue: _descriptor_10.fromValue(value_0),
      revealBytesValue: _descriptor_8.fromValue(value_0),
      bytesValue: _descriptor_11.fromValue(value_0),
      revealFieldValue: _descriptor_8.fromValue(value_0),
      fieldValue: _descriptor_12.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.revealBooleanValue).concat(_descriptor_8.toValue(value_0.booleanValue).concat(_descriptor_8.toValue(value_0.revealBigUnsignedValue).concat(_descriptor_10.toValue(value_0.bigUnsignedValue).concat(_descriptor_8.toValue(value_0.revealBytesValue).concat(_descriptor_11.toValue(value_0.bytesValue).concat(_descriptor_8.toValue(value_0.revealFieldValue).concat(_descriptor_12.toValue(value_0.fieldValue))))))));
  }
}
...
class _DummyClaimsDisclosures_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_8.alignment().concat(_descriptor_9.alignment().concat(_descriptor_8.alignment().concat(_descriptor_7.alignment().concat(_descriptor_8.alignment().concat(_descriptor_10.alignment().concat(_descriptor_8.alignment().concat(_descriptor_11.alignment().concat(_descriptor_8.alignment().concat(_descriptor_1.alignment().concat(_descriptor_8.alignment().concat(_descriptor_12.alignment().concat(_descriptor_8.alignment().concat(_descriptor_13.alignment().concat(_descriptor_8.alignment().concat(_descriptor_14.alignment().concat(_descriptor_8.alignment().concat(_descriptor_15.alignment().concat(_descriptor_8.alignment().concat(_descriptor_16.alignment().concat(_descriptor_8.alignment().concat(_descriptor_26.alignment().concat(_descriptor_8.alignment().concat(_descriptor_18.alignment())))))))))))))))))))))))));
  }
  fromValue(value_0) {
    return {
      revealBooleanValue: _descriptor_8.fromValue(value_0),
      booleanValue: _descriptor_8.fromValue(value_0),
      revealByteSizedUnsignedValue: _descriptor_8.fromValue(value_0),
      byteSizedUnsignedValue: _descriptor_9.fromValue(value_0),
      revealMediumUnsignedValue: _descriptor_8.fromValue(value_0),
      mediumUnsignedValue: _descriptor_7.fromValue(value_0),
      revealBigUnsignedValue: _descriptor_8.fromValue(value_0),
      bigUnsignedValue: _descriptor_10.fromValue(value_0),
      revealBytes16Value: _descriptor_8.fromValue(value_0),
      bytes16Value: _descriptor_11.fromValue(value_0),
      revealBytes32Value: _descriptor_8.fromValue(value_0),
      bytes32Value: _descriptor_1.fromValue(value_0),
      revealFieldValue: _descriptor_8.fromValue(value_0),
      fieldValue: _descriptor_12.fromValue(value_0),
      revealBooleanVector: _descriptor_8.fromValue(value_0),
      booleanVector: _descriptor_13.fromValue(value_0),
      revealUintVector: _descriptor_8.fromValue(value_0),
      uintVector: _descriptor_14.fromValue(value_0),
      revealBytesVector: _descriptor_8.fromValue(value_0),
      bytesVector: _descriptor_15.fromValue(value_0),
      revealFieldVector: _descriptor_8.fromValue(value_0),
      fieldVector: _descriptor_16.fromValue(value_0),
      revealNestedValue: _descriptor_8.fromValue(value_0),
      nestedValue: _descriptor_26.fromValue(value_0),
      revealNestedVector: _descriptor_8.fromValue(value_0),
      nestedVector: _descriptor_18.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.revealBooleanValue).concat(_descriptor_8.toValue(value_0.booleanValue).concat(_descriptor_8.toValue(value_0.revealByteSizedUnsignedValue).concat(_descriptor_9.toValue(value_0.byteSizedUnsignedValue).concat(_descriptor_8.toValue(value_0.revealMediumUnsignedValue).concat(_descriptor_7.toValue(value_0.mediumUnsignedValue).concat(_descriptor_8.toValue(value_0.revealBigUnsignedValue).concat(_descriptor_10.toValue(value_0.bigUnsignedValue).concat(_descriptor_8.toValue(value_0.revealBytes16Value).concat(_descriptor_11.toValue(value_0.bytes16Value).concat(_descriptor_8.toValue(value_0.revealBytes32Value).concat(_descriptor_1.toValue(value_0.bytes32Value).concat(_descriptor_8.toValue(value_0.revealFieldValue).concat(_descriptor_12.toValue(value_0.fieldValue).concat(_descriptor_8.toValue(value_0.revealBooleanVector).concat(_descriptor_13.toValue(value_0.booleanVector).concat(_descriptor_8.toValue(value_0.revealUintVector).concat(_descriptor_14.toValue(value_0.uintVector).concat(_descriptor_8.toValue(value_0.revealBytesVector).concat(_descriptor_15.toValue(value_0.bytesVector).concat(_descriptor_8.toValue(value_0.revealFieldVector).concat(_descriptor_16.toValue(value_0.fieldVector).concat(_descriptor_8.toValue(value_0.revealNestedValue).concat(_descriptor_26.toValue(value_0.nestedValue).concat(_descriptor_8.toValue(value_0.revealNestedVector).concat(_descriptor_18.toValue(value_0.nestedVector))))))))))))))))))))))))));
  }
}
...
class _Presentation_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_4.alignment().concat(_descriptor_5.alignment().concat(_descriptor_27.alignment())))));
  }
  fromValue(value_0) {
    return {
      version: _descriptor_0.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.version).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_1.toValue(value_0.credentialClaimRoot).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_5.toValue(value_0.holderBinding).concat(_descriptor_27.toValue(value_0.disclosed))))));
  }
}
...
class _VerificationTranscriptV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_9.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment()))))))))))))))))))))))))))))))))))))))))))))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
      version: _descriptor_0.fromValue(value_0),
      profile: _descriptor_9.fromValue(value_0),
      authority: _descriptor_9.fromValue(value_0),
      ...
      originMode: _descriptor_9.fromValue(value_0),
      ...
      credentialBindingMode: _descriptor_9.fromValue(value_0),
      ...
      issuerRelationship: _descriptor_9.fromValue(value_0),
      ...
      statusMode: _descriptor_9.fromValue(value_0),
      ...
      timeMode: _descriptor_9.fromValue(value_0),
...
class _EvidenceBindingV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_7.alignment().concat(_descriptor_7.alignment()))))))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
      version: _descriptor_0.fromValue(value_0),
      mode: _descriptor_9.fromValue(value_0),
...
class _SyntheticVerificationAttemptV1_0 {
  alignment() {
    return _descriptor_9.alignment().concat(_descriptor_9.alignment().concat(_descriptor_9.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment()))));
  }
  fromValue(value_0) {
    return {
      proofStatus: _descriptor_9.fromValue(value_0),
      decisionStatus: _descriptor_9.fromValue(value_0),
      authority: _descriptor_9.fromValue(value_0),
      executionStatus: _descriptor_9.fromValue(value_0),
      transcriptDigest: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_9.toValue(value_0.proofStatus).concat(_descriptor_9.toValue(value_0.decisionStatus).concat(_descriptor_9.toValue(value_0.authority).concat(_descriptor_9.toValue(value_0.executionStatus).concat(_descriptor_1.toValue(value_0.transcriptDigest)))));
  }
}
...
class _HolderActionReplayScopeV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_37.alignment()))))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.domain).concat(_descriptor_0.toValue(value_0.version).concat(_descriptor_1.toValue(value_0.deploymentDigest).concat(_descriptor_1.toValue(value_0.verifierContractDigest).concat(_descriptor_1.toValue(value_0.actionClassDigest).concat(_descriptor_1.toValue(value_0.actionScopeParametersDigest).concat(_descriptor_37.toValue(value_0.binding)))))));
  }
}
...
class _DecisionNullifierMaterialV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment())))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.domain).concat(_descriptor_0.toValue(value_0.version).concat(_descriptor_1.toValue(value_0.deploymentDigest).concat(_descriptor_1.toValue(value_0.verifierContractDigest).concat(_descriptor_9.toValue(value_0.replayPolicy).concat(_descriptor_1.toValue(value_0.replayScopeDigest))))));
  }
}
...
class _ConsentBindingV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_9.alignment())))))))))))))))))))))))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.domain).concat(_descriptor_0.toValue(value_0.version).concat(_descriptor_9.toValue(value_0.profile).concat(_descriptor_1.toValue(value_0.networkIdDigest).concat(_descriptor_1.toValue(value_0.verifierContractDigest).concat(_descriptor_1.toValue(value_0.deploymentDigest).concat(_descriptor_1.toValue(value_0.audienceDigest).concat(_descriptor_9.toValue(value_0.originMode).concat(_descriptor_1.toValue(value_0.originDigest).concat(_descriptor_1.toValue(value_0.requestIdDigest).concat(_descriptor_1.toValue(value_0.challengeDigest).concat(_descriptor_7.toValue(value_0.expiresAt).concat(_descriptor_1.toValue(value_0.credentialFamilyDigest).concat(_descriptor_1.toValue(value_0.schemaDigest).concat(_descriptor_1.toValue(value_0.disclosureDigest).concat(_descriptor_1.toValue(value_0.predicateDigest).concat(_descriptor_9.toValue(value_0.statusMode).concat(_descriptor_1.toValue(value_0.statusRegistryDigest).concat(_descriptor_1.toValue(value_0.statusRoot).concat(_descriptor_7.toValue(value_0.statusRegistryVersion).concat(_descriptor_1.toValue(value_0.statusFreshnessPolicyDigest).concat(_descriptor_1.toValue(value_0.policyDigest).concat(_descriptor_1.toValue(value_0.actionClassDigest).concat(_descriptor_1.toValue(value_0.actionInvocationDigest).concat(_descriptor_1.toValue(value_0.artifactManifestDigest).concat(_descriptor_9.toValue(value_0.replayPolicy))))))))))))))))))))))))));
  }
}
...
class _CredentialBindingV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment())))))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
...
class _HolderBindingV1_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment())))));
  }
  fromValue(value_0) {
    return {
      domain: _descriptor_1.fromValue(value_0),
...
class _StatusRegistryRef_0 {
  ...
  fromValue(value_0) {
    return {
      ...
      authorityVerificationMethodRef: _descriptor_4.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.registryId).concat(_descriptor_4.toValue(value_0.authorityVerificationMethodRef));
  }
}
...
class _RegistryBoundStatusBinding_0 {
  alignment() {
    return _descriptor_45.alignment().concat(_descriptor_46.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_45.toValue(value_0.statusType).concat(_descriptor_46.toValue(value_0.registryRef).concat(_descriptor_1.toValue(value_0.statusHandleCommitment)));
  }
}
...
class _OffchainMidnightHolderBinding_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_22.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.holderDidStateHash).concat(_descriptor_1.toValue(value_0.holderMethodId).concat(_descriptor_22.toValue(value_0.holderPublicKey)));
  }
}
...
class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_50.alignment().concat(_descriptor_56.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_2.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.schema).concat(_descriptor_50.toValue(value_0.capabilities).concat(_descriptor_56.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_57 = new _SchemaDescriptor_0();

const _descriptor_58 = new __compactRuntime.CompactTypeVector(2, _descriptor_1);

const _descriptor_59 = new __compactRuntime.CompactTypeVector(3, _descriptor_1);

const _descriptor_60 = new __compactRuntime.CompactTypeVector(4, _descriptor_1);

const _descriptor_61 = new __compactRuntime.CompactTypeVector(5, _descriptor_1);
