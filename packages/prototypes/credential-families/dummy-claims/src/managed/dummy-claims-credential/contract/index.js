...
class _RegistryBoundStatusBinding_0 {
  alignment() {
    return _descriptor_40.alignment().concat(_descriptor_41.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_40.toValue(value_0.statusType).concat(_descriptor_41.toValue(value_0.registryRef).concat(_descriptor_1.toValue(value_0.statusHandleCommitment)));
  }
}
...
class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_45.alignment().concat(_descriptor_50.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_2.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.schema).concat(_descriptor_45.toValue(value_0.capabilities).concat(_descriptor_50.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_51 = new _SchemaDescriptor_0();

const _descriptor_52 = new __compactRuntime.CompactTypeVector(2, _descriptor_1);

const _descriptor_53 = new __compactRuntime.CompactTypeVector(4, _descriptor_1);

const _descriptor_54 = new __compactRuntime.CompactTypeVector(3, _descriptor_1);

const _descriptor_55 = new __compactRuntime.CompactTypeVector(5, _descriptor_1);
