...
const _descriptor_30 = new _BirthCredentialIssuanceResultBody_0();

class _ResultMessage_1 {
  alignment() {
    return _descriptor_21.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_22.alignment().concat(_descriptor_30.alignment()))));
  }
  fromValue(value_0) {
    return {
      envelope: _descriptor_21.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_21.toValue(value_0.envelope).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_22.toValue(value_0.holderBindingProfile).concat(_descriptor_30.toValue(value_0.body)))));
  }
}

const _descriptor_31 = new _ResultMessage_1();
...
const _descriptor_32 = new _BirthCredentialIssuanceRequestBody_0();

class _RequestMessage_1 {
  alignment() {
    return _descriptor_21.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_22.alignment().concat(_descriptor_32.alignment()))));
  }
  fromValue(value_0) {
    return {
      envelope: _descriptor_21.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_21.toValue(value_0.envelope).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_22.toValue(value_0.holderBindingProfile).concat(_descriptor_32.toValue(value_0.body)))));
  }
}

const _descriptor_33 = new _RequestMessage_1();
...
class _OfferMessage_0 {
  alignment() {
    return _descriptor_21.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_22.alignment().concat(_descriptor_27.alignment().concat(_descriptor_34.alignment())))));
  }
  fromValue(value_0) {
    return {
      envelope: _descriptor_21.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_21.toValue(value_0.envelope).concat(_descriptor_2.toValue(value_0.schema).concat(_descriptor_4.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_22.toValue(value_0.holderBindingProfile).concat(_descriptor_27.toValue(value_0.features).concat(_descriptor_34.toValue(value_0.body))))));
  }
}

const _descriptor_35 = new _OfferMessage_0();

const _descriptor_36 = new __compactRuntime.CompactTypeEnum(0, 0);
...
const _descriptor_37 = new _StatusRegistryRef_0();

class _RegistryBoundStatusBinding_0 {
  alignment() {
    return _descriptor_36.alignment().concat(_descriptor_37.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
      statusType: _descriptor_36.fromValue(value_0),
      registryRef: _descriptor_37.fromValue(value_0),
      statusHandleCommitment: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_36.toValue(value_0.statusType).concat(_descriptor_37.toValue(value_0.registryRef).concat(_descriptor_1.toValue(value_0.statusHandleCommitment)));
  }
}

const _descriptor_38 = new _RegistryBoundStatusBinding_0();
...
const _descriptor_39 = new _SchemaCapabilities_0();
...
const _descriptor_42 = new _OffchainMidnightHolderBinding_0();
...
const _descriptor_43 = new _JubjubHolderBinding_0();
...
const _descriptor_44 = new _SchemaFamilyResolutionHint_0();

class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_39.alignment().concat(_descriptor_44.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_2.fromValue(value_0),
      capabilities: _descriptor_39.fromValue(value_0),
      familyResolutionHint: _descriptor_44.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.schema).concat(_descriptor_39.toValue(value_0.capabilities).concat(_descriptor_44.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_45 = new _SchemaDescriptor_0();

const _descriptor_46 = new __compactRuntime.CompactTypeVector(5, _descriptor_1);

const _descriptor_47 = new __compactRuntime.CompactTypeVector(4, _descriptor_1);

const _descriptor_48 = new __compactRuntime.CompactTypeVector(3, _descriptor_1);
