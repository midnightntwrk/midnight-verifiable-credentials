...
export type MixedClaimsPublicClaims = { credentialTypeCode: bigint;
                                        issuerJurisdictionCode: Uint8Array;
                                        assuranceLevel: bigint
                                      };

export type MixedClaimsClaimCommitments = { subjectIdCommitment: Uint8Array;
                                            birthDateCommitment: Uint8Array;
                                            accountTierCommitment: Uint8Array
                                          };

export type MixedClaimsDisclosures = { publicClaims: MixedClaimsPublicClaims;
                                       revealSubjectId: boolean;
                                       subjectId: Uint8Array;
                                       subjectIdOpening: Uint8Array;
                                       revealBirthDate: boolean;
                                       birthDateDays: bigint;
                                       birthDateOpening: Uint8Array;
                                       proveAccountTierAtLeast: boolean
                                     };

export type MixedClaimsPresentationRequest = { version: bigint;
                                               schema: SchemaRef;
                                               issuerVerificationMethodRef: VerificationMethodRef;
                                               requireSubjectIdDisclosure: boolean;
                                               requireBirthDateDisclosure: boolean;
                                               enforceMinimumAccountTier: boolean;
                                               minimumAccountTier: bigint;
                                               verifierChallengeHash: Uint8Array
                                             };

export type MixedClaimsCredential = { version: bigint,
                                      schema: SchemaRef,
                                      issuerVerificationMethodRef: VerificationMethodRef,
...
export type MixedClaimsPresentation = { version: bigint,
                                        schema: SchemaRef,
...
export type PureCircuits = {
  ...
  mixedClaimsPublicClaimsRoot(publicClaims_0: MixedClaimsPublicClaims): Uint8Array;
  mixedClaimsClaimCommitmentsRoot(claimCommitments_0: MixedClaimsClaimCommitments): Uint8Array;
  mixedClaimsClaimRoot(claims_0: MixedClaimsPublicClaims,
                       claimCommitments_0: MixedClaimsClaimCommitments): Uint8Array;
  mixedClaimsSubjectIdCommitment(subjectId_0: Uint8Array, opening_0: Uint8Array): Uint8Array;
  mixedClaimsBirthDateCommitment(birthDateDays_0: bigint, opening_0: Uint8Array): Uint8Array;
  mixedClaimsAccountTierCommitment(accountTier_0: bigint, opening_0: Uint8Array): Uint8Array;
  mixedClaimsCredentialBodyRoot(credential_0: MixedClaimsCredential): Uint8Array;
  mixedClaimsPresentationBodyRoot(presentation_0: MixedClaimsPresentation): Uint8Array;
  mixedClaimsPresentationRequestBodyRoot(request_0: MixedClaimsPresentationRequest): Uint8Array;
  assertValidMixedClaimsSchemaRef(schema_0: SchemaRef): [];
  assertValidMixedClaimsPresentationRequest(request_0: MixedClaimsPresentationRequest): [];
  assertValidMixedClaimsPublicClaims(publicClaims_0: MixedClaimsPublicClaims): [];
  assertMatchingMixedClaimsPublicDisclosures(disclosed_0: MixedClaimsDisclosures,
                                             claims_0: MixedClaimsPublicClaims): [];
  assertMatchingMixedClaimsPrivateDisclosures(disclosed_0: MixedClaimsDisclosures,
                                              claimCommitments_0: MixedClaimsClaimCommitments): [];
  assertValidMixedClaimsAccountTierPredicate(claimCommitments_0: MixedClaimsClaimCommitments,
                                             accountTierWitness_0: bigint,
                                             accountTierOpening_0: Uint8Array,
                                             minimumAccountTier_0: bigint): [];
  assertInactiveMixedClaimsAccountTierWitness(accountTierWitness_0: bigint,
                                              accountTierOpening_0: Uint8Array): [];
  assertValidMixedClaimsPredicateFlags(disclosed_0: MixedClaimsDisclosures,
                                       request_0: MixedClaimsPresentationRequest): [];
  assertValidMixedClaimsCredential(credential_0: MixedClaimsCredential,
                                   proof_0: Proof): [];
  assertValidMixedClaimsPresentation(credential_0: MixedClaimsCredential,
                                     credentialProof_0: Proof,
                                     presentation_0: MixedClaimsPresentation,
                                     presentationProof_0: Proof): [];
  assertMixedClaimsPresentationSatisfiesRequest(credential_0: MixedClaimsCredential,
                                                credentialProof_0: Proof,
                                                request_0: MixedClaimsPresentationRequest,
                                                presentation_0: MixedClaimsPresentation,
                                                presentationProof_0: Proof,
...
export type Circuits<PS> = {
  ...
  mixedClaimsPublicClaimsRoot(context: __compactRuntime.CircuitContext<PS>,
                              publicClaims_0: MixedClaimsPublicClaims): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsClaimCommitmentsRoot(context: __compactRuntime.CircuitContext<PS>,
                                  claimCommitments_0: MixedClaimsClaimCommitments): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsClaimRoot(context: __compactRuntime.CircuitContext<PS>,
                       claims_0: MixedClaimsPublicClaims,
                       claimCommitments_0: MixedClaimsClaimCommitments): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsSubjectIdCommitment(context: __compactRuntime.CircuitContext<PS>,
                                 subjectId_0: Uint8Array,
                                 opening_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsBirthDateCommitment(context: __compactRuntime.CircuitContext<PS>,
                                 birthDateDays_0: bigint,
                                 opening_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsAccountTierCommitment(context: __compactRuntime.CircuitContext<PS>,
                                   accountTier_0: bigint,
                                   opening_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsCredentialBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                credential_0: MixedClaimsCredential): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsPresentationBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                  presentation_0: MixedClaimsPresentation): __compactRuntime.CircuitResults<PS, Uint8Array>;
  mixedClaimsPresentationRequestBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                         request_0: MixedClaimsPresentationRequest): __compactRuntime.CircuitResults<PS, Uint8Array>;
  assertValidMixedClaimsSchemaRef(context: __compactRuntime.CircuitContext<PS>,
                                  schema_0: SchemaRef): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsPresentationRequest(context: __compactRuntime.CircuitContext<PS>,
                                            request_0: MixedClaimsPresentationRequest): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsPublicClaims(context: __compactRuntime.CircuitContext<PS>,
                                     publicClaims_0: MixedClaimsPublicClaims): __compactRuntime.CircuitResults<PS, []>;
  assertMatchingMixedClaimsPublicDisclosures(context: __compactRuntime.CircuitContext<PS>,
                                             disclosed_0: MixedClaimsDisclosures,
                                             claims_0: MixedClaimsPublicClaims): __compactRuntime.CircuitResults<PS, []>;
  assertMatchingMixedClaimsPrivateDisclosures(context: __compactRuntime.CircuitContext<PS>,
                                              disclosed_0: MixedClaimsDisclosures,
                                              claimCommitments_0: MixedClaimsClaimCommitments): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsAccountTierPredicate(context: __compactRuntime.CircuitContext<PS>,
                                             claimCommitments_0: MixedClaimsClaimCommitments,
                                             accountTierWitness_0: bigint,
                                             accountTierOpening_0: Uint8Array,
                                             minimumAccountTier_0: bigint): __compactRuntime.CircuitResults<PS, []>;
  assertInactiveMixedClaimsAccountTierWitness(context: __compactRuntime.CircuitContext<PS>,
                                              accountTierWitness_0: bigint,
                                              accountTierOpening_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsPredicateFlags(context: __compactRuntime.CircuitContext<PS>,
                                       disclosed_0: MixedClaimsDisclosures,
                                       request_0: MixedClaimsPresentationRequest): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsCredential(context: __compactRuntime.CircuitContext<PS>,
                                   credential_0: MixedClaimsCredential,
                                   proof_0: Proof): __compactRuntime.CircuitResults<PS, []>;
  assertValidMixedClaimsPresentation(context: __compactRuntime.CircuitContext<PS>,
                                     credential_0: MixedClaimsCredential,
                                     credentialProof_0: Proof,
                                     presentation_0: MixedClaimsPresentation,
                                     presentationProof_0: Proof): __compactRuntime.CircuitResults<PS, []>;
  assertMixedClaimsPresentationSatisfiesRequest(context: __compactRuntime.CircuitContext<PS>,
                                                credential_0: MixedClaimsCredential,
                                                credentialProof_0: Proof,
                                                request_0: MixedClaimsPresentationRequest,
                                                presentation_0: MixedClaimsPresentation,
