...
class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_47.alignment().concat(_descriptor_52.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_2.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.schema).concat(_descriptor_47.toValue(value_0.capabilities).concat(_descriptor_52.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_53 = new _SchemaDescriptor_0();

const _descriptor_54 = new __compactRuntime.CompactTypeVector(2, _descriptor_1);

const _descriptor_55 = new __compactRuntime.CompactTypeVector(3, _descriptor_1);

const _descriptor_56 = new __compactRuntime.CompactTypeVector(4, _descriptor_1);
