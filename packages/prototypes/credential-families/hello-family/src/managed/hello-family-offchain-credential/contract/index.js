...
class _RegistryBoundStatusBinding_0 {
  alignment() {
    return _descriptor_37.alignment().concat(_descriptor_38.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_37.toValue(value_0.statusType).concat(_descriptor_38.toValue(value_0.registryRef).concat(_descriptor_1.toValue(value_0.statusHandleCommitment)));
  }
}
...
const _descriptor_49 = new __compactRuntime.CompactTypeVector(2, _descriptor_1);
