...
const _descriptor_33 = new _BirthCredentialPrivateClaims_0();
...
const _descriptor_34 = new _BirthCredentialClaimOpenings_0();

class _BirthCredentialPrivateParts_0 {
  alignment() {
    return _descriptor_33.alignment().concat(_descriptor_34.alignment());
  }
  fromValue(value_0) {
    return {
      claims: _descriptor_33.fromValue(value_0),
      openings: _descriptor_34.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_33.toValue(value_0.claims).concat(_descriptor_34.toValue(value_0.openings));
  }
}

const _descriptor_35 = new _BirthCredentialPrivateParts_0();

class _BirthCredentialIssuanceResultBody_0 {
  alignment() {
    return _descriptor_12.alignment().concat(_descriptor_16.alignment().concat(_descriptor_13.alignment().concat(_descriptor_2.alignment().concat(_descriptor_35.alignment()))));
  }
  fromValue(value_0) {
    return {
      credential: _descriptor_12.fromValue(value_0),
      ...
      privateParts: _descriptor_35.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_12.toValue(value_0.credential).concat(_descriptor_16.toValue(value_0.credentialProof).concat(_descriptor_13.toValue(value_0.holderPublicKey).concat(_descriptor_2.toValue(value_0.issuanceChallengeHash).concat(_descriptor_35.toValue(value_0.privateParts)))));
  }
}

const _descriptor_36 = new _BirthCredentialIssuanceResultBody_0();

class _ResultMessage_1 {
  alignment() {
    return _descriptor_22.alignment().concat(_descriptor_4.alignment().concat(_descriptor_6.alignment().concat(_descriptor_25.alignment().concat(_descriptor_36.alignment()))));
  }
  fromValue(value_0) {
    return {
      envelope: _descriptor_22.fromValue(value_0),
      ...
      issuerVerificationMethodRef: _descriptor_6.fromValue(value_0),
      holderBindingProfile: _descriptor_25.fromValue(value_0),
      body: _descriptor_36.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_22.toValue(value_0.envelope).concat(_descriptor_4.toValue(value_0.schema).concat(_descriptor_6.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_25.toValue(value_0.holderBindingProfile).concat(_descriptor_36.toValue(value_0.body)))));
  }
}

const _descriptor_37 = new _ResultMessage_1();
...
const _descriptor_38 = new _BirthCredentialIssuanceOfferBody_0();

class _OfferMessage_0 {
  alignment() {
    return _descriptor_22.alignment().concat(_descriptor_4.alignment().concat(_descriptor_6.alignment().concat(_descriptor_25.alignment().concat(_descriptor_28.alignment().concat(_descriptor_38.alignment())))));
  }
  fromValue(value_0) {
    return {
      envelope: _descriptor_22.fromValue(value_0),
      ...
      holderBindingProfile: _descriptor_25.fromValue(value_0),
      features: _descriptor_28.fromValue(value_0),
      body: _descriptor_38.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_22.toValue(value_0.envelope).concat(_descriptor_4.toValue(value_0.schema).concat(_descriptor_6.toValue(value_0.issuerVerificationMethodRef).concat(_descriptor_25.toValue(value_0.holderBindingProfile).concat(_descriptor_28.toValue(value_0.features).concat(_descriptor_38.toValue(value_0.body))))));
  }
}

const _descriptor_39 = new _OfferMessage_0();
...
const _descriptor_45 = new _SecretHolderBinding_0();
...
class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_4.alignment().concat(_descriptor_43.alignment().concat(_descriptor_48.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_4.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.schema).concat(_descriptor_43.toValue(value_0.capabilities).concat(_descriptor_48.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_49 = new _SchemaDescriptor_0();

const _descriptor_50 = new __compactRuntime.CompactTypeVector(4, _descriptor_2);

const _descriptor_51 = new __compactRuntime.CompactTypeVector(5, _descriptor_2);
