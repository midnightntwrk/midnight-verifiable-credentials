...
const requiredBuildSurfaces = [
  ...
  {
    artifactPath: "packages/prototypes/credential-families/birth/dist/testing.js",
    sourcePaths: ["packages/prototypes/credential-families/birth/src/testing.ts"],
  },
  {
    artifactPath: "packages/prototypes/credential-families/birth-secret/dist/index.js",
    sourcePaths: ["packages/prototypes/credential-families/birth-secret/src/index.ts"],
  },
  {
    artifactPath: "packages/use-cases/age-gate/contract/dist/testing.js",
    sourcePaths: [
      "packages/use-cases/age-gate/contract/src/testing.ts",
      "packages/use-cases/age-gate/contract/src/demo-revocation-fixtures.ts",
    ],
  },
  {
    artifactPath: "packages/use-cases/age-gate/contract/dist/contract-revocation.js",
    sourcePaths: [
      "packages/use-cases/age-gate/contract/src/contract-revocation.ts",
