...
class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_4.alignment().concat(_descriptor_31.alignment().concat(_descriptor_37.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_4.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.schema).concat(_descriptor_31.toValue(value_0.capabilities).concat(_descriptor_37.toValue(value_0.familyResolutionHint)));
  }
}
...
const _descriptor_45 = new __compactRuntime.CompactTypeUnsignedInteger(4294967295n, 4);
  ...
  initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_45.toValue(0n),
                                                                                              alignment: _descriptor_45.alignment() }).encode() } },
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(0n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_45.toValue(tmp_0),
                                                                                              alignment: _descriptor_45.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
...
export function ledger(stateOrChargedState) {
  ...
  return {
    get contractVersion() {
      return _descriptor_45.fromValue(__compactRuntime.queryLedgerState(context,
                                                                        partialProofData,
                                                                        [
                                                                         { dup: { n: 0 } },
                                                                         { idx: { cached: false,
