...
export type HelloFamilyOffchainCredential = { version: bigint,
                                              schema: SchemaRef,
                                              issuerVerificationMethodRef: VerificationMethodRef,
                                              holderBinding: OffchainMidnightHolderBinding,
...
export type HelloFamilyOffchainPresentation = { version: bigint,
                                                schema: SchemaRef,
...
export type ImpureCircuits<PS> = {
  verifyHelloFamilyOffchainPresentationForHelloVerifier(context: __compactRuntime.CircuitContext<PS>,
                                                        credential_0: HelloFamilyOffchainCredential,
                                                        credentialProof_0: Proof,
                                                        request_0: HelloFamilyPresentationRequest,
                                                        presentation_0: HelloFamilyOffchainPresentation,
...
export type PureCircuits = {
  ...
  helloFamilyOffchainCredentialBodyRoot(credential_0: HelloFamilyOffchainCredential): Uint8Array;
  helloFamilyOffchainPresentationBodyRoot(presentation_0: HelloFamilyOffchainPresentation): Uint8Array;
  helloFamilyOffchainPresentationRequestBodyRoot(request_0: HelloFamilyPresentationRequest): Uint8Array;
  assertValidHelloFamilyOffchainSchemaRef(schema_0: SchemaRef): [];
  assertValidHelloFamilyOffchainPresentationRequest(request_0: HelloFamilyPresentationRequest): [];
  assertValidHelloFamilyOffchainCredential(credential_0: HelloFamilyOffchainCredential,
                                           proof_0: Proof): [];
  assertValidHelloFamilyOffchainPresentation(credential_0: HelloFamilyOffchainCredential,
                                             credentialProof_0: Proof,
                                             presentation_0: HelloFamilyOffchainPresentation,
                                             presentationProof_0: Proof): [];
  assertHelloFamilyOffchainPresentationSatisfiesRequest(credential_0: HelloFamilyOffchainCredential,
                                                        credentialProof_0: Proof,
                                                        request_0: HelloFamilyPresentationRequest,
                                                        presentation_0: HelloFamilyOffchainPresentation,
                                                        presentationProof_0: Proof): [];
  helloVerifierRequest(issuerVerificationMethodRef_0: VerificationMethodRef,
                       verifierChallengeHash_0: Uint8Array,
                       requireBytesValueDisclosure_0: boolean): HelloFamilyPresentationRequest;
}
...
export type Circuits<PS> = {
  ...
  helloFamilyClaimRoot(context: __compactRuntime.CircuitContext<PS>,
                       claims_0: HelloFamilyClaims): __compactRuntime.CircuitResults<PS, Uint8Array>;
  helloFamilyOffchainCredentialBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                        credential_0: HelloFamilyOffchainCredential): __compactRuntime.CircuitResults<PS, Uint8Array>;
  helloFamilyOffchainPresentationBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                          presentation_0: HelloFamilyOffchainPresentation): __compactRuntime.CircuitResults<PS, Uint8Array>;
  helloFamilyOffchainPresentationRequestBodyRoot(context: __compactRuntime.CircuitContext<PS>,
                                                 request_0: HelloFamilyPresentationRequest): __compactRuntime.CircuitResults<PS, Uint8Array>;
  assertValidHelloFamilyOffchainSchemaRef(context: __compactRuntime.CircuitContext<PS>,
                                          schema_0: SchemaRef): __compactRuntime.CircuitResults<PS, []>;
  assertValidHelloFamilyOffchainPresentationRequest(context: __compactRuntime.CircuitContext<PS>,
                                                    request_0: HelloFamilyPresentationRequest): __compactRuntime.CircuitResults<PS, []>;
  assertValidHelloFamilyOffchainCredential(context: __compactRuntime.CircuitContext<PS>,
                                           credential_0: HelloFamilyOffchainCredential,
                                           proof_0: Proof): __compactRuntime.CircuitResults<PS, []>;
  assertValidHelloFamilyOffchainPresentation(context: __compactRuntime.CircuitContext<PS>,
                                             credential_0: HelloFamilyOffchainCredential,
                                             credentialProof_0: Proof,
                                             presentation_0: HelloFamilyOffchainPresentation,
                                             presentationProof_0: Proof): __compactRuntime.CircuitResults<PS, []>;
  assertHelloFamilyOffchainPresentationSatisfiesRequest(context: __compactRuntime.CircuitContext<PS>,
                                                        credential_0: HelloFamilyOffchainCredential,
                                                        credentialProof_0: Proof,
                                                        request_0: HelloFamilyPresentationRequest,
                                                        presentation_0: HelloFamilyOffchainPresentation,
                                                        presentationProof_0: Proof): __compactRuntime.CircuitResults<PS, []>;
  helloVerifierRequest(context: __compactRuntime.CircuitContext<PS>,
                       issuerVerificationMethodRef_0: VerificationMethodRef,
                       verifierChallengeHash_0: Uint8Array,
                       requireBytesValueDisclosure_0: boolean): __compactRuntime.CircuitResults<PS, HelloFamilyPresentationRequest>;
  verifyHelloFamilyOffchainPresentationForHelloVerifier(context: __compactRuntime.CircuitContext<PS>,
                                                        credential_0: HelloFamilyOffchainCredential,
                                                        credentialProof_0: Proof,
                                                        request_0: HelloFamilyPresentationRequest,
...
export type Ledger = {
  ...
  readonly lastVerifiedBytesValue: Uint8Array;
}
