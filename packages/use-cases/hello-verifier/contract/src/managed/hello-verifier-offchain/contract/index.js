...
const _descriptor_50 = new _JubjubHolderBinding_0();
...
const _descriptor_51 = new _ExplicitHolderBinding_0();
...
const _descriptor_52 = new _SchemaFamilyResolutionHint_0();

class _SchemaDescriptor_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_47.alignment().concat(_descriptor_52.alignment()));
  }
  fromValue(value_0) {
    return {
      schema: _descriptor_5.fromValue(value_0),
      capabilities: _descriptor_47.fromValue(value_0),
      familyResolutionHint: _descriptor_52.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.schema).concat(_descriptor_47.toValue(value_0.capabilities).concat(_descriptor_52.toValue(value_0.familyResolutionHint)));
  }
}

const _descriptor_53 = new _SchemaDescriptor_0();

const _descriptor_54 = new __compactRuntime.CompactTypeVector(2, _descriptor_0);
...
const _descriptor_57 = new __compactRuntime.CompactTypeVector(5, _descriptor_0);
...
export class Contract {
  ...
  initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_60.toValue(0n),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_12.toValue(0n),
                                                                                              alignment: _descriptor_12.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_60.toValue(tmp_0),
                                                                                              alignment: _descriptor_60.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _helloFamilyClaimRoot_0(claims_0) {
    return this._persistentHash_20([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 118, 99, 58, 104, 101, 108, 108, 111, 45, 102, 97, 109, 105, 108, 121, 58, 118, 49, 0, 0, 0, 0, 0]),
                                                ...
                                                presentationProof_0)
  {
    ...
    if (presentation_0.disclosed.revealBytesValue) {
      __compactRuntime.assert(this._equal_193(presentation_0.disclosed.bytesValue,
    ...
    if (presentation_0.disclosed.revealBigUnsignedValue) {
      __compactRuntime.assert(this._equal_194(presentation_0.disclosed.bigUnsignedValue,
                                                           ...
                                                           presentationProof_0)
  {
    ...
    __compactRuntime.assert(this._equal_195(request_0.issuerVerificationMethodRef.didContractAddress,
                                            credential_0.issuerVerificationMethodRef.didContractAddress),
                            'Hello-family request issuer contract does not match the credential issuer');
    __compactRuntime.assert(this._equal_196(request_0.issuerVerificationMethodRef.methodId,
                                            credential_0.issuerVerificationMethodRef.methodId),
                            'Hello-family request issuer method does not match the credential issuer');
    __compactRuntime.assert(this._equal_197(presentationProof_0.challengeHash,
...
export function ledger(stateOrChargedState) {
  ...
  return {
    get contractVersion() {
      return _descriptor_60.fromValue(__compactRuntime.queryLedgerState(context,
                                                                        partialProofData,
                                                                        [
                                                                         { dup: { n: 0 } },
                                                                         { idx: { cached: false,
