...
import {
  ...
  type Proof,
  pureCircuits,
} from "./managed/hello-verifier-offchain/contract/index.js";
import {
  type HelloVerifierPrivateState,
  helloVerifierWitnesses,
} from "./witnesses.js";

export class HelloVerifierOffchainSimulator {
  ...
  public helloVerifierRequest(
    issuerVerificationMethodRef: HelloFamilyOffchainCredential["issuerVerificationMethodRef"],
  ...
  public verifyHelloFamilyOffchainPresentationForHelloVerifier(
    ...
    this.executeCircuit(() =>
      this.contract.impureCircuits.verifyHelloFamilyOffchainPresentationForHelloVerifier(
        this.circuitContext,
        credential,
        credentialProof,
        request,
