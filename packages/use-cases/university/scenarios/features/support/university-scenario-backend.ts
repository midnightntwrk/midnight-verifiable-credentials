...
} from "../../../../../../packages/components/integration/standalone-environment/dist/index.js";
import {
...
const safeScenarioTargetPath = (
  ...
  const allowedRoot = resolveScenarioRepoPath(
    "packages/use-cases/university/scenarios/target",
  );
...
class StandaloneHybridUniversityScenarioBackend implements UniversityScenarioBackend {
  ...
  readonly #overlayRoot =
    "packages/use-cases/university/scenarios/target/standalone-hybrid-data";
  readonly #timingArtifactRoot =
    "packages/use-cases/university/scenarios/target/standalone-timing";
  #proofExecutionBackend:
