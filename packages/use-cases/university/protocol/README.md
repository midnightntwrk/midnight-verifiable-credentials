...
challenge; unknown, mismatched, and same-run replayed request flows are
rejected. The supported restart simulation persists bindings and processed
thread identifiers through its checkpoint; broader production durable replay
protection is outside this private prototype's scope.
