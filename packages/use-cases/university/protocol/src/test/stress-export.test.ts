...
const buildStressRunner = (): UniversityProtocolFlowRunner =>
  new UniversityProtocolFlowRunner({
    dataPaths: {
      university: "packages/use-cases/university/data/stress-100/university.json",
      students: "packages/use-cases/university/data/stress-100/students.json",
      companies: "packages/use-cases/university/data/stress-100/companies.json",
      mall: "packages/use-cases/university/data/stress-100/mall.json",
      issuanceBatches: "packages/use-cases/university/data/stress-100/issuance-batches.json",
      discountApplicants:
        "packages/use-cases/university/data/stress-100/discount-applicants.json",
    },
  });
...
const buildCohortRunner = (): UniversityProtocolFlowRunner =>
  new UniversityProtocolFlowRunner({
    dataPaths: {
      university: "packages/use-cases/university/data/cohort-30/university.json",
      students: "packages/use-cases/university/data/cohort-30/students.json",
      companies: "packages/use-cases/university/data/cohort-30/companies.json",
      mall: "packages/use-cases/university/data/cohort-30/mall.json",
      issuanceBatches:
        "packages/use-cases/university/data/cohort-30/issuance-batches.json",
      discountApplicants:
        "packages/use-cases/university/data/cohort-30/discount-applicants.json",
    },
  });
  ...
  it("builds the intermediate cohort summary with richer verifier and discount diversity", () => {
    ...
    const summary = buildUniversityProtocolStressSummary(
      ...
      wallClockMs,
      {
        ...
        artifactTargetDir: "packages/use-cases/university/protocol/target/cohort-30",
      },
    );
    ...
    expect(summary.artifactRetention.targetDir).toBe(
      "packages/use-cases/university/protocol/target/cohort-30",
    );
  }, STRESS_TEST_TIMEOUT_MS);
