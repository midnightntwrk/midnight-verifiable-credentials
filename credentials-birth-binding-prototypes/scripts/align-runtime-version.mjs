...
const targetFile = path.join(packageRoot, 'src', 'managed', 'birth-binding-prototypes', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'birth-binding-prototypes', 'contract', 'index.d.ts');
