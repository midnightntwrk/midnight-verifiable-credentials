...
```bash
npm run --silent build:university-ci-matrix:markdown > use-cases/university/ci-matrix.md
...
```text
use-cases/university/scenarios/target/standalone-hybrid-data/backend-metadata.json
```
...
```text
use-cases/university/scenarios/target/standalone-timing/summary.json
```
...
```bash
./run.sh university-protocol-export --light
open use-cases/university/protocol/target/readable-10/transcript-export.md
```
...
open use-cases/university/scenarios/target/standalone-timing/summary.md
```
