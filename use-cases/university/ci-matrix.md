...
| `protocol-export` | `./run.sh university-protocol-export` | `ci:university-protocol:export` | light profile: `managed-university-protocol-export`<br>artifacts: `use-cases/university/protocol/target/transcript.json`, `use-cases/university/protocol/target/application-decisions.json` | Transcript schema, application decision schema, or export formatting changes. |
